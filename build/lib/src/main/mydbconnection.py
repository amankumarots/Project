...
class Connect:
    ...
    def connection_db(self, env):
        ...
        try:
            ...
            self.logger.info("Database connection established {}@{} with password {}".format
...
class EmployeeDetails:
    ...
    def query1(self):
        try:
            ...
            html = df.to_html()
            text_file = open("C:\\Users\\vinitha.muralidharan\\PycharmProjects\\"
                             "EmployeeDetails\\src\\Results\\emp_branch_facility.html", "w")
    ...
    def query2(self):
        try:
            ...
            html = df.to_html()
            text_file = open("C:\\Users\\vinitha.muralidharan\\PycharmProjects\\"
                             "EmployeeDetails\\src\\Results\\employee_count_in_each_skill.html", "w")
            text_file.write(html)
            text_file.close()
...
if __name__ == '__main__':
    ...
    db1 = Connect()
    obj1 = db1.connection_db(envi)
    c_obj = EmployeeDetails(obj1)
